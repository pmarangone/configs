...
alias cls='clear'
alias md='mkdir'
alias gclip='/usr/local/bin/myclip.sh'
alias bk='. /usr/local/bin/back.sh'
alias edbash='vim ~/.bashrc'
alias upbash='source ~/.bashrc'
alias edneo='nvim ~/.config/nvim/init.lua'
alias ii='explorer.exe $1'
alias rmv='rm -r -f $1'
alias mk='make $1'
alias co='code .'
alias nv='nvim $1'
...
eval "$(oh-my-posh --init --shell bash --config ~/.poshthemes/mystar.omp.json)"
	
[[ -s /home/mestto/.autojump/etc/profile.d/autojump.sh ]] && source /home/mestto/.autojump/etc/profile.d/autojump.sh
...
export PATH="$PATH:/home/mestto/.foundry/bin"
